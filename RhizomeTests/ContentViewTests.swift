...
final class ContentViewTests: XCTestCase {
    ...
    func testContentViewInitialization() throws {
        ...
        XCTAssertFalse(contentView.showVideo)
        XCTAssertFalse(contentView.inPlayroom)
    }
    
    func testContentViewInitializationWithNilSchedule() throws {
    ...
    func testParseScheduleWithActiveAppointment() throws {
    ...
    func testParseScheduleWithInactiveAppointment() throws {
    ...
    func testParseScheduleWithNilSchedule() throws {
    ...
    func testParseScheduleWithEmptyDaycare() throws {
